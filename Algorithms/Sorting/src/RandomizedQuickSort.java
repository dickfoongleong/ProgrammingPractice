...
public class RandomizedQuickSort {
	...
	public static int randomizedPartition(int[] list, int strIdx, int endIdx) {
		int ranIdx = new Random().nextInt((endIdx - strIdx) + 1) + strIdx;
		exchangeVal(list, ranIdx, endIdx);
		return partition(list, strIdx, endIdx);
	}
